...
- /workspace/glame-platform/reports/glame_daily_plan_refresh_t_ae648f3a_summary_20260528_1050_fixed.json
...
- One material workflow change vs 10:34 UTC: `Проверить устаревание синхронизации 1С` moved from pending_approval to queued / `В работе`, so the 1C admin-review lane appears actively queued/running now.
- Numeric sales, CRM, app-analytics, catalog and customer baselines remain unchanged materially; the daily plan still requires approval before execution/write-back.

## Business data snapshot

Sales:
- Today (2026-05-28T00:00:00): revenue 0 RUB, checks 0, items sold 0, source orders_fallback.
- Last 7 days: revenue 457 435 RUB, checks 38, average check 12037.76 RUB, items sold 179, unique customers 22, last sale 2026-05-27T18:45:06+00:00, source sales_records.
- Recent online/API orders endpoint returned 1 order record(s); listed amount 12080.0 RUB; statuses pending.
...
- Segments: Sleeping=4647, Regular=920, New=433, Active=201, VIP=8, unknown=7
...
2. P1 data-freshness lane
   ...
   - Because the 1C review card is now queued/В работе, do not duplicate it; wait for result or admin decision.
